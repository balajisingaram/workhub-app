...
export const MOCK_FREELANCERS: Freelancer[] = [
  {
    ...
    bio: 'Award-winning UI/UX designer with 8 years of experience building digital products for Fortune 500 companies and fast-growing startups. I specialise in turning complex problems into elegant, user-centred solutions.',
    hourlyRateMin: 60,
    hourlyRateMax: 80,
    ...
    education: [
      { id: 'e1', degree: 'BFA in Graphic Design', institution: 'Parsons School of Design', year: '2015', description: 'Graduated magna cum laude. Focus on interaction design and digital media.' },
    ],
    experience: [
      { id: 'ex1', title: 'Senior UX Designer', company: 'Stripe', period: '2020–2023', description: 'Led design for Stripe Dashboard, improving merchant activation by 34%.' },
      { id: 'ex2', title: 'Product Designer', company: 'Figma', period: '2018–2020', description: 'Core product team — contributed to the launch of FigJam.' },
    ],
    services: [
      ...
      { id: 's2', title: 'Mobile App UI Design (iOS or Android)', description: 'Beautiful, conversion-optimised mobile interfaces', price: 349, deliveryDays: 5, category: 'Design', rating: 4.8, reviewCount: 32 },
      { id: 's3', title: 'Design System Creation in Figma', description: 'Scalable design tokens, components and documentation', price: 799, deliveryDays: 10, category: 'Design', rating: 5.0, reviewCount: 21 },
    ],
  },
  {
    id: 'fl-002',
    ...
    bio: 'Full-stack engineer with 6 years building scalable web applications. Expert in React, Node.js, PostgreSQL and AWS. Clean code advocate and open source contributor.',
    hourlyRateMin: 75,
    hourlyRateMax: 100,
    ...
    education: [
      { id: 'e1', degree: 'MS Computer Science', institution: 'Stanford University', year: '2018', description: 'Specialisation in distributed systems and databases.' },
    ],
    experience: [
      { id: 'ex1', title: 'Senior Software Engineer', company: 'Vercel', period: '2021–2024', description: 'Core infrastructure team — improved build performance by 60%.' },
    ],
    services: [
      ...
      { id: 's2', title: 'REST API Development', description: 'Scalable Node.js API with authentication and docs', price: 599, deliveryDays: 7, category: 'Development', rating: 4.9, reviewCount: 28 },
    ],
    availability: 'available',
  },
  {
    ...
    avatarUrl: 'https://api.dicebear.com/7.x/avataaars/svg?seed=maya&backgroundColor=ffd5dc',
    bio: 'Creative brand designer with a deep love for storytelling through visuals. I help businesses build memorable identities that resonate with their audience.',
    hourlyRateMin: 45,
    hourlyRateMax: 65,
    location: 'London, UK',
    timezone: 'GMT (UTC+0)',
    englishLevel: 'Native',
    skills: ['Adobe Illustrator', 'Branding', 'Logo Design', 'Typography', 'Packaging', 'Figma'],
    rating: 4.8,
    reviewCount: 216,
    jobsCompleted: 180,
    ...
    portfolioItems: [
      ...
      { id: 'p2', title: 'Tech Startup Logo System',      imageUrl: 'https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=400&q=80', category: 'Logo' },
    ],
    education: [],
    experience: [],
    services: [
      { id: 's1', title: 'Complete Brand Identity Package', description: 'Logo, colour palette, typography, brand guidelines', price: 699, deliveryDays: 10, category: 'Design', rating: 4.9, reviewCount: 86, isFeatured: true },
    ],
  },
  {
    id: 'fl-004',
    ...
    avatarUrl: 'https://api.dicebear.com/7.x/avataaars/svg?seed=james&backgroundColor=d1f0d1',
    bio: 'Results-driven digital marketer with a track record of growing organic traffic by 300%+ and delivering measurable ROI through data-driven campaigns.',
    hourlyRateMin: 55,
    hourlyRateMax: 75,
    ...
    experience: [],
    services: [
      { id: 's1', title: 'Full SEO Audit & Strategy', description: 'Comprehensive audit with actionable 90-day roadmap', price: 399, deliveryDays: 5, category: 'Marketing', rating: 4.7, reviewCount: 42 },
    ],
  },
  {
    id: 'fl-005',
    ...
    bio: 'Mobile app developer specialising in React Native. Delivered 20+ apps on both iOS and Android with 4.8+ App Store ratings.',
    hourlyRateMin: 65,
    hourlyRateMax: 85,
    location: 'Bangalore, India',
    timezone: 'IST (UTC+5:30)',
    englishLevel: 'Professional',
    skills: ['React Native', 'Expo', 'TypeScript', 'Firebase', 'Redux', 'iOS', 'Android'],
    rating: 4.9,
    reviewCount: 61,
    jobsCompleted: 52,
    responseTime: '< 1 hour',
    ...
    experience: [],
    services: [
      { id: 's1', title: 'React Native App (iOS + Android)', description: 'Cross-platform mobile app from design to App Store', price: 1999, deliveryDays: 21, category: 'Mobile', rating: 4.9, reviewCount: 28, isFeatured: true },
    ],
  },
  {
    id: 'fl-006',
    ...
    avatarUrl: 'https://api.dicebear.com/7.x/avataaars/svg?seed=carlos&backgroundColor=b6e3f4',
    bio: 'Conversion copywriter and content strategist. I help SaaS companies and e-commerce brands tell their story and convert readers into customers.',
    hourlyRateMin: 35,
    hourlyRateMax: 55,
    location: 'Barcelona, Spain',
    timezone: 'CET (UTC+1)',
    englishLevel: 'Professional',
    skills: ['Copywriting', 'SEO Writing', 'Blog Posts', 'Email Copy', 'Landing Pages', 'UX Writing'],
    rating: 4.8,
    reviewCount: 144,
    jobsCompleted: 128,
    ...
    experience: [],
    services: [
      { id: 's1', title: 'Landing Page Copywriting', description: 'High-converting copy for SaaS and product landing pages', price: 299, deliveryDays: 3, category: 'Writing', rating: 4.8, reviewCount: 64 },
    ],
  },
  {
    id: 'fl-007',
    ...
    avatarUrl: 'https://api.dicebear.com/7.x/avataaars/svg?seed=yuki&backgroundColor=ffd5dc',
    bio: 'Motion designer creating scroll-stopping animations and video content for brands. After Effects, Cinema 4D, and Premiere are my home.',
    hourlyRateMin: 50,
    hourlyRateMax: 70,
    location: 'Tokyo, Japan',
    timezone: 'JST (UTC+9)',
    englishLevel: 'Conversational',
    skills: ['After Effects', 'Cinema 4D', 'Premiere Pro', 'Motion Graphics', '3D Animation'],
    rating: 4.9,
    reviewCount: 77,
    jobsCompleted: 63,
    ...
    experience: [],
    services: [
      { id: 's1', title: 'Brand Animation & Intro Video', description: '15-second brand animation for social and website', price: 449, deliveryDays: 5, category: 'Video', rating: 4.9, reviewCount: 38 },
    ],
  },
  {
    id: 'fl-008',
    ...
    avatarUrl: 'https://api.dicebear.com/7.x/avataaars/svg?seed=amara&backgroundColor=d1f0d1',
    bio: 'Data scientist with expertise in building ML pipelines, predictive models, and data dashboards. Python, pandas, scikit-learn, and TensorFlow daily.',
    hourlyRateMin: 80,
    hourlyRateMax: 120,
    location: 'Amsterdam, Netherlands',
    timezone: 'CET (UTC+1)',
    englishLevel: 'Professional',
    skills: ['Python', 'Machine Learning', 'TensorFlow', 'SQL', 'Tableau', 'Data Analysis'],
    rating: 4.8,
    reviewCount: 39,
    jobsCompleted: 31,
    responseTime: '2 hours',
    ...
    experience: [],
    services: [
      { id: 's1', title: 'Custom ML Model Development', description: 'End-to-end model training, evaluation and deployment', price: 1599, deliveryDays: 14, category: 'Data Science', rating: 4.8, reviewCount: 18 },
    ],
  },
]
